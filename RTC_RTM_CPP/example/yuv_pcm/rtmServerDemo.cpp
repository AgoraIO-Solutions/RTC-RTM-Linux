...
string APP_ID = "d6b10eddcf514ca79254ed90936fdcef";
...
#if RTM
static std::vector<std::unique_ptr<Demo>> DemoList;
static std::vector<bool> loginStatus;
static int rtmCount = 3;
